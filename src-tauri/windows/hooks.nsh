...
!macro KillTeleoperatorMcpFleetProcesses
  DetailPrint "Stopping teleoperator-mcp processes..."
  ExecWait 'taskkill /F /IM teleoperator-mcp-backend.exe /T' $0
  ExecWait 'taskkill /F /IM teleoperator-mcp-native.exe /T' $0
...
!macro NSIS_HOOK_PREINSTALL
  !insertmacro KillTeleoperatorMcpFleetProcesses
!macroend
...
!macro NSIS_HOOK_POSTINSTALL
  IfFileExists "$INSTDIR\resources\install-mcp-clients.ps1" 0 mcp_hook_done
    DetailPrint "Optional: register teleoperator-mcp in Cursor / Claude Desktop"
